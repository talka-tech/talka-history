        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          <div className="text-center space-y-8 animate-fade-in">
            ...
            <div className="flex items-center justify-center space-x-4 mb-8 animate-slide-up">
              <div className="w-16 h-16 rounded-2xl bg-purple-200/40 backdrop-blur-sm flex items-center justify-center border border-purple-300/50 p-3 hover:scale-110 transition-transform duration-300 shadow-lg">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-2">
            <div className="lg:hidden flex items-center justify-center space-x-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-purple-200/40 backdrop-blur-sm flex items-center justify-center p-2 shadow-lg border border-purple-300/50">
                <img src="/img/logo.png" alt="Talka Logo" className="w-full h-full object-contain" />
              </div>
